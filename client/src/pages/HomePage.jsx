...
const HomePage = () => {
    return (
        <div className="text-center bg-white p-12 rounded-lg shadow-lg">
            ...
            <h4 className="px-6 py-3 font-extrabold text-gray-400 mb-4">Admin Details</h4>
            
            <h4 className="px-6 font-extrabold text-gray-400 mb-4">Admin Email: admin@gmail.com</h4>
            <h4 className="px-6 font-extrabold text-gray-400 mb-4">Admin Password: Admin@1234</h4>
